...
# Part 1 - initial policy is to move down (towards s4)
"""
...
def plot_trials(sarsa, ql, alpha, epsilon, lam):
    ...
    fname = "hw4-paceym-lambda-results.png"
    plt.savefig(fname, dpi=250)
    print(f"Lambda plot saved to {fname}")
...
def actor_critic():
    print("Actor Critic Done")

def main():
    # SARSA and Q-Learning
    # alpha, epsilon, lam = tune_hyperparams()
    # alpha, epsilon, lam = 0.17, 0.001, 0.1
